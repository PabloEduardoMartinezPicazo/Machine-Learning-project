...
dir = os.path.dirname
#funciones de la clase sql y para la lectura del json
...
def upload_sql(df, json_readed): 
    ...
    df.to_sql(name='Pablo_Eduardo_Martinez_Picazo', con = engine, if_exists = 'replace', index=False)
